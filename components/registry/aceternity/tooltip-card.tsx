...
// Builder wrapper
export default function TooltipCardWrapper() {
  return (
    <div className="flex items-center justify-center p-12">
      <Tooltip content="This is a tooltip with rich content support">
        <button className="rounded-md bg-neutral-900 px-4 py-2 text-white dark:bg-white dark:text-black">
          Hover me
        </button>
      </Tooltip>
    </div>
