      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-16 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <motion.div
            ...
            whileHover={{
              boxShadow: '0 0 0 1px hsl(var(--primary) / 0.2), 0 16px 48px rgba(0,0,0,0.08)',
              transition: { duration: 0.3 },
            }}
            className="flex flex-col justify-between rounded-2xl border border-border bg-card p-8 md:col-span-2 lg:row-span-2"
          >
            <div>
              <motion.div
            ...
            <div className="mt-8 flex h-48 items-center justify-center rounded-xl bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/10">
          ...
          {smallFeatures.map((feature, index) => (
            <motion.div
              ...
              whileHover={{
                y: -4,
                boxShadow: '0 0 0 1px hsl(var(--primary) / 0.15), 0 12px 36px rgba(0,0,0,0.06)',
                transition: { duration: 0.3 },
              }}
