      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-20">
        ...
        >
          ...
          >
            ...
            <motion.button
              className="inline-flex h-12 items-center justify-center rounded-lg border border-input bg-background px-8 text-sm font-medium text-foreground shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              variants={buttonVariants}
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.97 }}
            >
