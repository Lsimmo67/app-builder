      ...
      <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            {/* App Store Button */}
            <button className="inline-flex h-14 items-center gap-3 rounded-xl bg-foreground px-6 text-background transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
        ...
        <div className="flex items-center justify-center">
          <div className="relative mx-auto w-64">
            <div className="rounded-[3rem] border-4 border-foreground/10 bg-muted p-3">
              <div className="flex h-[500px] flex-col items-center justify-center rounded-[2.5rem] bg-gradient-to-b from-primary/10 to-primary/5">
                ...
                <p className="mt-4 text-sm text-muted-foreground">App Preview</p>
              </div>
            </div>
            {/* Notch */}
